...
// - The first three if or else if statements check the general location of the cell
// - The input is a 9x9 sudoku grid and the exact row and column to start at
// - It solves from left the right at the top left corner (grid[0][0] is the top left)
...
// The number to see if you can put the number there without breaking the rules
...
// in the adjacent block. it then resources through the grid, if it runs into a case where it can't find a suitable
