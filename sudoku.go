...
// check if grid is valid if we add a specific cell
// Function takes current grid as well as x&y coords
// Checks if adding a specific number works with the sudoku or not
